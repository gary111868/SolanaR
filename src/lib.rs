...
#[derive(Debug)]
pub struct SolanaRPCProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SolanaRPCProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SolanaRPC processing");
    
    let mut processor = SolanaRPCProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SolanaRPCProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SolanaRPCProcessor::new(false);
